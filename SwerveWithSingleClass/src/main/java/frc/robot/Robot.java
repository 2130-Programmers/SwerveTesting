...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    ...
    RobotContainer.swerveDriveSubsystem.zeroAllEncoders();
  }
  ...
  public void teleopPeriodic() {
    ...
    SmartDashboard.putNumber("Limelight X", RobotContainer.limelightSubsystem.x);
    SmartDashboard.putNumber("Limelight Y", RobotContainer.limelightSubsystem.y);
    SmartDashboard.putNumber("LimelightArea", RobotContainer.limelightSubsystem.area);

    RobotContainer.swerveDriveSubsystem.zeroAllEncodersBasedOnProx();
